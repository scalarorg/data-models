...
type VaultTransaction struct {
	gorm.Model
	BlockHeight uint64 `gorm:"type:bigint;index:idx_vault_transaction_block_position,unique"`
	TxPosition  uint   `gorm:"type:bigint;default:0;index:idx_vault_transaction_block_position,unique"`
